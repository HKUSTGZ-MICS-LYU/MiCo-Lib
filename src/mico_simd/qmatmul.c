...
extern __mico_mixed8x4_vecXmat(qword* a, qword* w, int32_t* o, int n, int m);
...
extern __mico_mixed8x2_vecXmat(qword* a, qword* w, int32_t* o, int n, int m);
...
extern __mico_mixed8x1_vecXmat(qword* a, qword* w, int32_t* o, int n, int m);
