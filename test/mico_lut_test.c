// Test for LUT-based MatMul implementations
// Compares LUT-based results against reference implementation
...
int main() {
    printf("=== LUT-based MatMul Regression Test ===\n");
    ...
    int32_t *output_lut = (int32_t *)malloc(N * M * sizeof(int32_t));
    ...
    memset(output_lut, 0, N * M * sizeof(int32_t));
    ref_Q8x2_MatMul(output_ref, &x_8bit, &w_2bit);
    MiCo_Q8x2_MatMul(output_lut, &x_8bit, &w_2bit);
    total_errors += compare_outputs(output_ref, output_lut, N * M, "Q8x2_MatMul");
    ...
    MiCo_Q8x4_MatMul(output_lut, &x_8bit, &w_4bit);
    total_errors += compare_outputs(output_ref, output_lut, N * M, "Q8x4_MatMul");
    ...
    MiCo_Q8x1_MatMul(output_lut, &x_8bit, &w_1bit);
    total_errors += compare_outputs(output_ref, output_lut, N * M, "Q8x1_MatMul");
    ...
    MiCo_Q8_MatMul(output_lut, &x_8bit, &w_8bit);
    total_errors += compare_outputs(output_ref, output_lut, N * M, "Q8_MatMul");
    ...
    MiCo_Q4_MatMul(output_lut, &x_4bit, &w_4bit);
    total_errors += compare_outputs(output_ref, output_lut, N * M, "Q4_MatMul");
    ...
    MiCo_Q2_MatMul(output_lut, &x_2bit, &w_2bit);
    total_errors += compare_outputs(output_ref, output_lut, N * M, "Q2_MatMul");
    ...
    MiCo_Q1_MatMul(output_lut, &x_1bit, &w_1bit);
    total_errors += compare_outputs(output_ref, output_lut, N * M, "Q1_MatMul");
    ...
    MiCo_Q4x8_MatMul(output_lut, &x_4bit, &w_8bit);
    total_errors += compare_outputs(output_ref, output_lut, N * M, "Q4x8_MatMul");
    ...
    MiCo_Q2x8_MatMul(output_lut, &x_2bit, &w_8bit);
    total_errors += compare_outputs(output_ref, output_lut, N * M, "Q2x8_MatMul");
    ...
    MiCo_Q1x8_MatMul(output_lut, &x_1bit, &w_8bit);
    total_errors += compare_outputs(output_ref, output_lut, N * M, "Q1x8_MatMul");
    ...
    MiCo_Q4x2_MatMul(output_lut, &x_4bit, &w_2bit);
    total_errors += compare_outputs(output_ref, output_lut, N * M, "Q4x2_MatMul");
    ...
    MiCo_Q4x1_MatMul(output_lut, &x_4bit, &w_1bit);
    total_errors += compare_outputs(output_ref, output_lut, N * M, "Q4x1_MatMul");
    ...
    MiCo_Q2x1_MatMul(output_lut, &x_2bit, &w_1bit);
    total_errors += compare_outputs(output_ref, output_lut, N * M, "Q2x1_MatMul");
    ...
    MiCo_Q2x4_MatMul(output_lut, &x_2bit, &w_4bit);
    total_errors += compare_outputs(output_ref, output_lut, N * M, "Q2x4_MatMul");
    ...
    MiCo_Q1x4_MatMul(output_lut, &x_1bit, &w_4bit);
    total_errors += compare_outputs(output_ref, output_lut, N * M, "Q1x4_MatMul");
    ...
    MiCo_Q1x2_MatMul(output_lut, &x_1bit, &w_2bit);
    total_errors += compare_outputs(output_ref, output_lut, N * M, "Q1x2_MatMul");
