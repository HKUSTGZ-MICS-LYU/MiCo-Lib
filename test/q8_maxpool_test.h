// Test configuration for quantized max pooling
// This file defines test parameters for Q8_MaxPool2D

#ifndef Q8_MAXPOOL_TEST_H
#define Q8_MAXPOOL_TEST_H
